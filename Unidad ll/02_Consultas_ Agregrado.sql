...
-- seleciona el presio mas bajo de los producos
 select 
 min(UnitPrice) -- es para buscar el presio mas peque�o
 from Products
...
-- paso 4
    ...
    COUNT(ProductID) AS TotalProductos -- N�mero de productos en la categor�a
	FROM Products
	GROUP BY CategoryID
	HAVING 
    COUNT(ProductID) > 10; -- Solo categor�as con m�s de 10 productos
